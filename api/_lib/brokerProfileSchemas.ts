/**
 * Vercel-bundled copy of @workspace/api-schemas broker profile Zod schemas.
 * Keep in sync with lib/api-schemas/src/brokerProfile.ts (mobile imports the workspace package).
 */
import { z } from "zod";
